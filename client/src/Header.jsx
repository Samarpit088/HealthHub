  ...
  return (
    <header className="flex items-center justify-between py-12 px-20">
      <Link to={"/"} href="" className="flex items-center">
        ...
        <span className="font-fredoka font-bold text-2xl text-[#06182B] ">
          HealthHub
        </span>
      </Link>
      <div className="flex gap-4 items-center">
        <Link
          to={"/health"}
          className="font-fredoka font-bold text-xl cursor-pointer text-[#06182B] hover:underline"
        >
          Assistant
        </Link>
        <Link
        ...
        {!!user ? (
          <div className="ml-2">
            <div className="flex gap-2 border bg-[#ABBFCF] border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300">
              <Link
                to={"/account"}
                className="bg-white rounded-full border border-[#ABBFCF] p-[0.2rem] w-10 h-10 flex items-center justify-center text-[#ABBFCF] transition-all duration-500 hover:w-12 hover:h-12 cursor-pointer"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
          ...
          <div className="ml-2 ">
            <div className="flex gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300">
              <Link
                to={"/login"}
                className="bg-[#ABBFCF] rounded-full border border-[#ABBFCF] p-[0.2rem] w-10 h-10 flex items-center justify-center text-white transition-all duration-500 hover:w-12 hover:h-12 cursor-pointer"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
